    ...
    return (
        <div className="mt-24 p-5 xl:px-52 xl:py-5">
            <div className='text-gray-600 space-y-3 text-sm p-5 md:p-20 border border-gray-200 shadow rounded-md bg-white'>
                ...
                <p>The Famous (“TheFamous”, “we”, “us”, or “our”) is committed to protecting your privacy. We have prepared this Privacy Policy to describe to you our practices regarding the Personal Data (as defined below) we collect, use, and share in connection with the TheFamous.xyz website, mobile app, and other software provided on or in connection with our services, as described in our Terms of Service (collectively, the “Service”). “NFT” in this Privacy Policy means a non-fungible token or similar digital item implemented on a blockchain (such as the Algorand blockchain), which uses smart contracts to link to or otherwise be associated with certain content or data.</p>
                ...
                <ol className='list-decimal ml-6 space-y-3'>
                    ...
                    <li>
                        ...
                        <ul className='list-disc ml-6 space-y-3'>
                            ...
                            <li>
                                Legal Rights. Regardless of any choices you make regarding your Personal Data (as described below), TheFamous may disclose Personal Data if it believes in good faith that such disclosure is necessary: (a) in connection with any legal investigation; (b) to comply with relevant laws or to respond to subpoenas, warrants, or other legal process served on TheFamous; (c) to protect or defend the rights or property of TheFamous or users of the Service; and/or (d) to investigate or assist in preventing any violation or potential violation of the law, this Privacy Policy, or our Terms of Service.
                            </li>
                            <li>
                    ...
                    <li>
                        Third-Party Wallets. To use our Service, you must use a third-party wallet which allows you to engage in transactions on public blockchains. Your interactions with any third-party wallet provider are governed by the applicable terms of service and privacy policy of that third party.
                    </li>
                    <li>
                    ...
                    <li>
                        Minors. Our Terms of Service require all users to be at least 18 years old.
                    </li>
                    <li>
                        Changes to This Privacy Policy. This Privacy Policy may be updated from time to time for any reason. We will notify you of any changes to our Privacy Policy by posting the new Privacy Policy at https://thefamous.xyz/privacy. The date the Privacy Policy was last revised is identified at the beginning of this Privacy Policy. You are responsible for periodically visiting our Service and this Privacy Policy to check for any changes.
                    </li>
                    <li>
                        Questions; Contacting The Famous; Reporting Violations. If you have any questions or concerns or complaints about our Privacy Policy or our data collection or processing practices, or if you want to report any security violations to us, please contact us by using at Legal@thfamous.xyz
                    </li>
                </ol>
            </div>
        </div>
