...
import { signup, login, logout, getAuthMessage, loginMyAlgo } from 'modules/auth/apis';
...
const Signup = () => {
  ...
  return (
    ...
    <div className='bg-famous bg-no-repeat bg-fixed bg-contain bg-center md:min-h-screenFooter flex flex-col items-center pb-24 mt-32'>
      ...
      <div className="border border-white bg-white w-3/4 md:w-1/2 lg:w-1/3 p-4 flex flex-col justify-center my-5 mt-10 
      hover:bg-opacity-100 rounded-xl shadow-md hover:shadow-lg transform duration-200 ease-in-out">
        ...
        >
          <div className='flex flex-row text-sm md:text-lg justify-center'>
            ...
            <h4 className='font-semibold'>Sign up with your wallet</h4>
          </div>
      ...
      <div className="border border-white bg-white w-3/4 md:w-1/2 lg:w-1/3 p-4 flex flex-col justify-center 
        hover:bg-opacity-100 rounded-xl shadow-md hover:shadow-lg transform duration-200 ease-in-out">
        <div 
        ...
        >
          ...
          <h4 className='font-semibold'>Sign up with Email and Password</h4>
        </div>
        <div className={`mt-5 ${isShowLogin ? 'block' : 'hidden'}`}>
          <form onSubmit={handleSubmit} className='space-y-3'>
            ...
            <Input
              ...
              <Input
                ...
                />  
            <button type="submit"
              className="p-2 border text-blue-900 border-blue-900 rounded-md hover:bg-blue-900 hover:text-white w-full">
              Sign up
            </button>
          </form>
          <h1 className="text-sm text-center font-medium text-blue-900 mt-2">
      ...
      <div className='flex flex-row text-sm md:text-lg justify-center text-blue-900 mt-3'>
        <h4 className='font-semibold'>Do you have an account? Please <Link to="/login" className="underline">log in</Link> now</h4>
      </div>
    </div>
    <Modal
      isOpen={isModalOpen}
